...
public:
    ...
    void CalJacobianBurgers(const double dt, Eigen::Matrix<double,18,18> &Jac, double s_eff, const Eigen::Matrix<double,6,1> &sig_i, const Eigen::Matrix<double,6,1> &eps_K_i);

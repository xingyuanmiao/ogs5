...
public:
    ...
    void CalViscoelasticResidual(const double dt, const Eigen::Matrix<double,6,1> &dstrain_curr, const Eigen::Matrix<double,6,1> &dstrain_t,
                                          const double e_curr, const double e_t, const Eigen::Matrix<double,6,1> &stress_curr, const Eigen::Matrix<double,6,1> &stress_t,
                                          Eigen::Matrix<double,6,1> &strain_Kel_curr, const Eigen::Matrix<double,6,1> &strain_Kel_t, Eigen::Matrix<double,12,1> &res);
    ...
    void CalEPdGdE(const double dt, Eigen::Matrix<double,21,6> &dGdE);

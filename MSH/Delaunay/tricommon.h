...
public:
	...
	void Set( int n, int p0, int p1, int p2 ) { id = n;
		                                    point[0] = p0;
		                                    point[1] = p1;
		                                    point[2] = p2; }
...
DXPORT int      CreateConvexHull( int nPoints,
                                  std::vector<Cp_dbl2>* PntList,
...
DXPORT bool bSaveTriFile_TRI(char* szTriFile,
                             std::vector<Cp_dtri>* TriList,
                             std::vector<Cp_dbl3>* pnt);
...
DXPORT bool bResetTriangleList_TRI( int,
                                    std::vector<int>*,
                                    std::vector<Cp_dtri>*,
                                    std::vector<Cp_dtri>* );

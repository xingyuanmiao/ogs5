...
public:
	...
	virtual void move(Point mp){ cd_x += mp.cd_x;
		                     cd_y += mp.cd_y;
		                     cd_z += mp.cd_z; }
	virtual void reduce(double rate){ cd_x /= rate;
		                          cd_y /= rate;
		                          cd_z /= rate; }                               //point reduce
	virtual void expand(double rate){ cd_x *= rate;
		                          cd_y *= rate;
		                          cd_z *= rate; }                               //point expand
	virtual void reverse(){ cd_x = -cd_x;
		                cd_y = -cd_y;
		                cd_z = -cd_z; }                             //change plus to minus(minus to plus)

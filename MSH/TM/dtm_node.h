...
public:
	...
	void setY(double y){ Point::setY(y);
		             renew(); }
	void setZ(double z){ Point::setZ(z);
		             renew(); }
	void moveX(double x){   Point::moveX(x);
		                renew(); }
	void moveY(double y){   Point::moveY(y);
		                renew(); }
	void moveZ(double z){   Point::moveZ(z);
		                renew(); }
	void move(Point mp) {   Point::move(mp);
		                renew(); }
